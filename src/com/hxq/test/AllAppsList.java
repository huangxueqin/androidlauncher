...
//     */
    ...
    public void addPackage(Context context, String packageName) {
        ...
        if (matches.size() > 0) {
            for (ResolveInfo info : matches) {
                add(new ShortcutInfo(context.getPackageManager(), info, mIconCache));
            }
        }
    }
    ...
    public void updatePackage(Context context, String packageName) {
        ...
        if (matches.size() > 0) {
            ...
            for (int i = data.size() - 1; i >= 0; i--) {
                ...
                final ComponentName component = applicationInfo.getComponentName();
                if (packageName.equals(component.getPackageName())) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                ShortcutInfo shortcutInfo = findShortcutInfoLocked(
                        info.activityInfo.applicationInfo.packageName,
                        info.activityInfo.name);
                if (shortcutInfo == null) {
                    add(new ShortcutInfo(context.getPackageManager(), info, mIconCache));
                } else {
                    mIconCache.remove(shortcutInfo.getComponentName());
                    mIconCache.getTitleAndIcon(shortcutInfo, info);
            ...
            for (int i = data.size() - 1; i >= 0; i--) {
                ...
                final ComponentName component = shortcutInfo.getComponentName();
                if (packageName.equals(component.getPackageName())) {
     ...
     */
    private ShortcutInfo findShortcutInfoLocked(String packageName, String className) {
